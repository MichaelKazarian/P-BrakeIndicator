...
* **Резистор 10 Ом (Gate Resistor):** Встановлюється у розрив лінії між виводом **PA3** та Затвором (Gate) для гасіння високочастотного дзвону та обмеження зарядного струму затвора.
* **Резистор 1 кОм (Pull-Down):** Встановлюється між Затвором (Gate) та Витоком (Source) для надійного закриття транзистора, коли мікроконтролер мовчить.
